  ...
  methods: _objectSpread(_objectSpread({
    ...
    sendReturnItems: function sendReturnItems() {
      ...
      this.sendOrderReturn().then(function (response) {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].success(_this.$translate("Frontend::Template.returnConfirmationInfo")).closeAfter(3000);
        ...
        [
          _c(
            ...
            [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.$translate("Frontend::Template.returnSelectAll")) +
                  "\n            "
              ),
              _c("i", {
          ...
          _c(
            ...
            [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.$translate("Frontend::Template.returnTrigger")) +
                  "\n            "
              ),
              _c("i", {
            ...
            _c("div", { staticClass: "modal-content" }, [
              _c("div", { staticClass: "modal-header" }, [
                _c("h3", { staticClass: "modal-title" }, [
                  _vm._v(
                    _vm._s(_vm.$translate("Frontend::Template.returnSendBack"))
                  )
                ]),
                _vm._v(" "),
                _c(
                ...
                _c(
                  ...
                  [
                    ...
                    _c("label", { attrs: { for: "contact_wish" } }, [
                      _vm._v(
                        _vm._s(
                          _vm.$translate("Frontend::Template.returnReason")
                        )
                      )
                    ])
                  ]
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._v(
                      "\n                        " +
                        _vm._s(
                          _vm.$translate("Frontend::Template.returnCancel")
                        ) +
                        "\n                    "
                    )
                  ]
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._v(
                      "\n                        " +
                        _vm._s(
                          _vm.$translate("Frontend::Template.returnConfirm")
                        ) +
                        "\n                    "
                    )
                  ],
                  ...
                  ? [
                      _c("div", { staticClass: "mt-3" }, [
                        _c("strong", [
                          _vm._v(
                            _vm._s(
                              _vm.$translate("Frontend::Template.basketItemId")
                            ) + ":"
                          )
                        ]),
                        _vm._v(" "),
...
//# sourceMappingURL=logic-client-3.js.map