  ...
  methods: {
    ...
    getInvalidOptionTooltip: function getInvalidOptionTooltip(attributeId, attributeValueId) {
      ...
      if (invalidSelection.newUnit) {
        names.push("<b>" + this.$translate("Frontend::Template.singleItemContent") + "</b>");
      }
      ...
      return this.$translate("Frontend::Template.singleItemNotAvailableInSelection", {
        name: names.join(", ")
      });
    },
    ...
    correctSelection: function correctSelection(invalidSelection) {
      ...
      try {
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
          ...
          messages.push(this.$translate("Frontend::Template.singleItemNotAvailable", {
      ...
      if (invalidSelection.newUnit) {
        if (this.lastContentCount > 1 && this.possibleUnitCombinationIds.length > 1 && !Object(_helper_utils__WEBPACK_IMPORTED_MODULE_24__["isNull"])(this.selectedUnit)) {
          messages.push(this.$translate("Frontend::Template.singleItemNotAvailable", {
            name: this.$translate("Frontend::Template.singleItemContent")
          }));
        }
                              ...
                              _vm.addPleaseSelectOption || !_vm.hasSelection
                                ? _c("option", { domProps: { value: -1 } }, [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$translate(
                                          "Frontend::Template.singleItemPleaseSelect"
                                        )
                                      )
                                    )
                                  ])
                                ...
                                ? _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.$translate(
                                            "Frontend::Template.singleItemNoSelection"
                                          )
                                        )
                                      )
                                    ]
                                      ...
                                      ? [
                                          _vm._v(
                                            "\n                            " +
                                              _vm._s(
                                                _vm.$translate(
                                                  "Frontend::Template.singleItemNotSalableAttribute",
                                                  { name: value.name }
                                                )
                                              ) +
                                              "\n                        "
                                      ...
                                      : [
                                          _vm._v(
                                            "\n                            " +
                                              _vm._s(
                                                _vm.$translate(
                                                  "Frontend::Template.singleItemInvalidAttribute",
                                                  { name: value.name }
                                                )
                                              ) +
                                              "\n                        "
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.singleItemContent"
                            )
                          )
                        )
                      ]
...
//# sourceMappingURL=logic-client-11.js.map