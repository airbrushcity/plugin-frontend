        ...
        this.$store.dispatch("updateBasketItemQuantity", {
          ...
          if (_this2.isPreview) {
            _this2.$store.dispatch("addBasketNotification", {
              type: "error",
              message: _services_TranslationService__WEBPACK_IMPORTED_MODULE_23__["default"].translate("Frontend::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_22__["default"].get(error.data.exceptionCode.toString()), error.data.placeholder)
            });
          } else {
            NotificationService.error(_services_TranslationService__WEBPACK_IMPORTED_MODULE_23__["default"].translate("Frontend::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_22__["default"].get(error.data.exceptionCode.toString()), error.data.placeholder)).closeAfter(5000);
          }
          ...
          !_vm.basketItems.length > 0
            ? _c("div", [
                _c("div", { staticClass: "h5 py-3" }, [
                  _vm._v(
                    _vm._s(_vm.$translate("Frontend::Template.basketNoItems"))
                  )
                ])
              ])
            : _vm._e(),
                            ...
                            _c("div", [
                              _c("strong", [
                                _vm._v(
                                  _vm._s(
                                    _vm.$translate(
                                      "Frontend::Template.basketContent"
                                    )
                                  ) + ": "
                                )
                              ]),
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(
                              _vm.$translate("Frontend::Template.basketDelete")
                            ) +
                            "\n                            "
                        ),
                        _c("icon", {
                ...
                ? _c("div", { staticClass: "small" }, [
                    _c("div", { staticClass: "font-weight-bold my-1" }, [
                      _vm._v(
                        _vm._s(
                          _vm.$translate(
                            "Frontend::Template.basketAdditionalOptions"
                          )
                        ) + ":"
                      )
                    ]),
                                    ...
                                    ? [
                                        _vm._v(
                                          "(" +
                                            _vm._s(
                                              _vm.$translate(
                                                "Frontend::Template.basketIncludeAbbr"
                                              )
                                            ) +
                                            " " +
                                            _vm._s(
                            ...
                            _c("div", { staticClass: "mt-3" }, [
                              _c("strong", [
                                _vm._v(
                                  _vm._s(
                                    _vm.$translate(
                                      "Frontend::Template.basketItemId"
                                    )
                                  ) + ":"
                                )
                              ]),
                              ...
                              ? _c("div", [
                                  _c("strong", [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$translate(
                                          "Frontend::Template.basketItemNumber"
                                        )
                                      ) + ":"
                                    )
                                  ]),
                              ...
                              ? _c("div", [
                                  _c("strong", [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$translate(
                                          "Frontend::Template.basketAvailability"
                                        )
                                      ) + ":"
                                    )
                                  ]),
                ...
                ? _c("label", {
                    ...
                    attrs: {
                      "data-show-more": _vm.$translate(
                        "Frontend::Template.basketShowMore"
                      ),
                      "data-show-less": _vm.$translate(
                        "Frontend::Template.basketShowLess"
                      )
                    },
                    on: {
    ...
    ? _c(
        ...
        [
          _c("div", { staticClass: "mb-2" }, [
            _c("strong", [
              _vm._v(
                _vm._s(_vm.$translate("Frontend::Template.itemSetContent"))
              )
            ])
          ]),
          _vm._v(" "),
        ...
        _vm.orderProperties && _vm.orderProperties.length
          ? _c("div", { staticClass: "small" }, [
              _c("div", { staticClass: "font-weight-bold my-1" }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate("Frontend::Template.basketAdditionalOptions")
                  ) + ":"
                )
              ]),
              _vm._v(" "),
...
//# sourceMappingURL=logic-client-4.js.map