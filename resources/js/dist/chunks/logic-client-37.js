  ...
  return _c("div", { class: { "has-crossprice": _vm.hasCrossPrice } }, [
    ...
    _c(
      ...
      [
              ...
              ? [
                  _vm._v(
                    "\n                " +
                      _vm._s(
                        _vm.$translate(
                          "Frontend::Template.dynamicVariationPrice",
                          {
        ...
        _c("sup", [
          _vm._v(
            _vm._s(_vm.$translate("Frontend::Template.singleItemFootnote1"))
          )
        ])
      ]
    ),
          ...
          [
            _c("div", [
              _vm._v(
                "\n            " +
                  _vm._s(
                    _vm.$translate("Frontend::Template.singleItemContent")
                  ) +
                  "\n            "
              ),
              _c("span", [
            ...
            _vm.currentVariation.variation.mayShowUnitPrice
              ? _c("div", [
                  _vm._v(
                    "\n            " +
                      _vm._s(
                        _vm.$translate("Frontend::Template.singleItemUnitPrice")
                      ) +
                      "\n            "
                  ),
...
//# sourceMappingURL=logic-client-37.js.map