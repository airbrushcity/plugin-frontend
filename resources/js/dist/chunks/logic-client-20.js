  ...
  methods: {
    redeemCode: function redeemCode() {
      ...
      if (this.couponCode.length > 0) {
        ...
        this.$store.dispatch("redeemCouponCode", this.couponCode).then(function (response) {
          ...
          NotificationService.success(_services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template.couponRedeemSuccess")).closeAfter(10000);
        }, function (error) {
          _this2.waiting = false;
          NotificationService.error(_this2.getCouponRedemptionErrorMessage(error)).closeAfter(10000);
        });
      } else {
        NotificationService.error(_services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template.couponIsEmpty")).closeAfter(10000);
      }
    },
    removeCode: function removeCode() {
      ...
      this.$store.dispatch("removeCouponCode", this.couponCode).then(function (response) {
        ...
        NotificationService.success(_services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template.couponRemoveSuccess")).closeAfter(10000);
      }, function (error) {
        _this3.waiting = false;
        NotificationService.error(_services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template.couponRemoveFailure")).closeAfter(10000);
      });
    },
    getCouponRedemptionErrorMessage: function getCouponRedemptionErrorMessage(error) {
      ...
      if (errorCode > 0 && _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_10__["default"].has(errorCode.toString())) {
        return _services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_10__["default"].get(errorCode.toString()));
      }

      return _services_TranslationService__WEBPACK_IMPORTED_MODULE_11__["default"].translate("Frontend::Template.couponRedeemFailure");
    }
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "cmp" }, [
    ...
    !!_vm.$translate("Frontend::Template.couponReadonlyInfoText")
      ? _c("p", [
    ...
    _c(
      ...
      [
        _c("input", {
          ...
          attrs: {
            type: "text",
            placeholder: _vm.$translate("Frontend::Template.couponEnterCoupon"),
            ...
            ? _c(
                ...
                [
                  ...
                  _vm._v(
                    "\n                " +
                      _vm._s(
                        _vm.$translate("Frontend::Template.couponRedeem")
                      ) +
                      "\n            "
                  )
                ],
            ...
            : _c(
                ...
                [
                  ...
                  _vm._v(
                    "\n                " +
                      _vm._s(
                        _vm.$translate("Frontend::Template.couponRemove")
                      ) +
                      "\n            "
                  )
                ],
...
//# sourceMappingURL=logic-client-20.js.map