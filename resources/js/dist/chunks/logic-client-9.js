    ...
    _vm.showItemBundleItems
      ? _c(
          ...
          [
            _c("strong", [
              _vm._v(
                _vm._s(_vm.$translate("Frontend::Template.itemBundleContent"))
              )
            ]),
            _vm._v(" "),
            ...
            _c("div", [
              _c("p", { staticClass: "title mb-0" }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate(
                      "Frontend::Widget.itemBundlePlaceholderTitle"
                    )
                  )
                )
              ]),
              ...
              _c("p", { staticClass: "description mt-3" }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate(
                      "Frontend::Widget.itemBundlePlaceholderDescription"
                    )
                  )
                )
              ])
...
//# sourceMappingURL=logic-client-9.js.map