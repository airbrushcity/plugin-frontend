  ...
  methods: {
    ...
    submit: function submit() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"].put("/rest/io/customer/mail/" + this.contactId, {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_1__["default"].success(_this.$translate("Frontend::Template.myAccountChangeEmailSuccessful")).closeAfter(3000);
        window.location.assign(window.location.origin);
      }).fail(function () {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_1__["default"].error(_this.$translate("Frontend::Template.myAccountChangeEmailFailed")).closeAfter(10000);
      }).always(function () {
    ...
    [
      _c("div", { staticClass: "input-unit mt-3" }, [
        _c(
          ...
          [
            _vm._v(
              _vm._s(_vm.$translate("Frontend::Template.myAccountNewEmail"))
            )
          ]
        ),
        _vm._v(" "),
      ...
      _c("div", { staticClass: "input-unit" }, [
        _c("label", { attrs: { for: "password" + _vm._uid } }, [
          _vm._v(_vm._s(_vm.$translate("Frontend::Template.loginPassword")))
        ]),
        _vm._v(" "),
        _c("input", {
          directives: [
      ...
      _c(
        ...
        [
          _c("span", [
            _vm._v(
              _vm._s(_vm.$translate("Frontend::Template.myAccountChangeEmail"))
            )
          ]),
          _vm._v(" "),
...
//# sourceMappingURL=logic-client-25.js.map