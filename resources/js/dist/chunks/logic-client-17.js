              ...
              [
                _c("div", { staticClass: "modal-header" }, [
                  _c("div", { staticClass: "modal-title h5" }, [
                    _vm._v(
                      _vm._s(
                        _vm.$translate("Frontend::Template.singleItemAdded")
                      )
                    )
                  ]),
                  _vm._v(" "),
                          ...
                          _vm.countAdditionalBasketItems > 0
                            ? _c("span", [
                                _vm._v(
                                  _vm._s(
                                    _vm.$translate(
                                      "Frontend::Template.basketItemOverlayAdditionalCount",
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.singleItemAdditionalOptions"
                                      )
                                    ) + ":"
                                  )
                                ]
                                              ...
                                              ? [
                                                  _vm._v(
                                                    "(" +
                                                      _vm._s(
                                                        _vm.$translate(
                                                          "Frontend::Template.singleItemIncludeAbbr"
                                                        )
                                                      ) +
                                                      " " +
                                                      _vm._s(
                    ...
                    [
                      ...
                      _vm._v(
                        "\n                        " +
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.singleItemBasket"
                            )
                          ) +
                          "\n                    "
                      )
                    ...
                    [
                      ...
                      _vm._v(
                        "\n                        " +
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.singleItemCheckout"
                            )
                          ) +
                          "\n                    "
                      )
...
//# sourceMappingURL=logic-client-17.js.map