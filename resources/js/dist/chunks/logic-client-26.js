  ...
  methods: {
    validatePassword: function validatePassword() {
      ...
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_1__["default"].validate(this.$refs.resetPasswordForm).done(function () {
        ...
        if (validation === "password") {
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_5__["default"].error(_this.$translate("Frontend::Template.resetPwInvalidPassword"));
        } else if (validation === "ref") {
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_5__["default"].error(_this.$translate("Frontend::Template.resetPwRepeatNewPassword"));
        }
      });
    },
    saveNewPassword: function saveNewPassword() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_4__["default"].post("/rest/io/customer/password", {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_5__["default"].success(_this2.$translate("Frontend::Template.resetPwChangePasswordSuccessful")).closeAfter(3000);
      }).fail(function () {
        _this2.isDisabled = false;
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_5__["default"].error(_this2.$translate("Frontend::Template.resetPwChangePasswordFailed")).closeAfter(5000);
      });
    }
  }
});
  ...
  return _c(
    ...
    [
          ...
          _c(
            ...
            [
                      ...
                      return [
                        _vm._v(
                          "\n                    " +
                            _vm._s(
                              _vm.$translate(
                                "Frontend::Template.resetPwPasswordHintTitle"
                              )
                            ) +
                            "\n                "
                        )
                        ...
                        _c("ul", { staticClass: "pl-3" }, [
                          _c("li", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.resetPwPasswordHintLength"
                                )
                              )
                            )
                          ]),
                          ...
                          _c("li", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.resetPwPasswordHintDigit"
                                )
                              )
                            )
                          ]),
                          ...
                          _c("li", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.resetPwPasswordHintChar"
                                )
                              )
                            )
                          ])
              ...
              _c("label", { attrs: { for: _vm._uid + "password_first" } }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate("Frontend::Template.resetPwNewPassword")
                  ) + "*"
                )
              ])
            ],
        ...
        [
          _c("div", { staticClass: "input-unit" }, [
            ...
            _c("label", { attrs: { for: _vm._uid + "password_second" } }, [
              _vm._v(
                _vm._s(
                  _vm.$translate("Frontend::Template.resetPwRepeatPassword")
                ) + "*"
              )
            ])
          ])
      ...
      _c(
        ...
        [
          _c("span", [
            _vm._v(_vm._s(_vm.$translate("Frontend::Template.resetPwSave")))
          ]),
          _vm._v(" "),
          _c("i", {
...
//# sourceMappingURL=logic-client-26.js.map