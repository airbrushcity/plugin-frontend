...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    labelHtml: function labelHtml() {
      var contactPrivacyPolicy = this.$translate("Frontend::Template.contactPrivacyPolicy", {
        "hyphen": "&shy;"
      });
      var html = "\n                <!----><a href=\"".concat(App.urls.privacyPolicy, "\" target=\"_blank\" class=\"text-appearance\">\n                    <span>").concat(contactPrivacyPolicy, "</span>\n                </a><!---->\n            ");
      return this.$translate("Frontend::Template.contactAcceptPrivacyPolicy", {
        policy: html
      });
    }
  },
      ...
      Object(_helper_executeReCaptcha__WEBPACK_IMPORTED_MODULE_16__["executeReCaptcha"])(this.$refs.registrationForm).then(function (recaptchaToken) {
        _services_ValidationService__WEBPACK_IMPORTED_MODULE_14__["default"].validate(_this2.$refs.registrationForm).done(function () {
          if (!_this2.enableConfirmingPrivacyPolicy || _this2.privacyPolicyAccepted) {
            ...
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_21__["default"].error(_this2.$translate("Frontend::Template.contactAcceptFormPrivacyPolicy", {
              hyphen: "&shy;"
            }));
          ...
          if (invalidFieldNames.length > 0) {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_21__["default"].error(_this2.$translate("Frontend::Template.checkoutCheckAddressFormFields", {
    ...
    sendRegistration: function sendRegistration(recaptchaToken) {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_20__["default"].post("/rest/io/customer", userObject).done(function (response) {
        ...
        if (!response.code) {
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_21__["default"].success(_this3.$translate("Frontend::Template.regSuccessful")).closeAfter(3000);
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_21__["default"].error(_this3.$translate("Frontend::Template.regError")).closeAfter(10000);
  ...
  computed: {
    currentSalutation: function currentSalutation() {
      ...
      var salutations = this.salutations.map(function (salutation) {
        return {
          key: salutation.key,
          name: _this.$translate("Frontend::Template." + salutation.name)
        };
      });
                                ...
                                "\n                            " +
                                  _vm._s(
                                    _vm.transformTranslation(
                                      "Frontend::Template.addressSalutation",
                                      "de",
                                      "delivery_address.salutation"
                                    )
                                  ) +
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.$translate(
                                    "Frontend::Template.addressCompany"
                                  )
                                ) + "*"
                              )
                            ]
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressTitle",
                                        "de",
                                        "delivery_address.title"
                                      )
                                    ) +
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.addressFirstName"
                                      )
                                    )
                                  ),
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.addressLastName"
                                      )
                                    )
                                  ),
                                  _vm.areNameFieldsRequired(
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressContactPerson",
                                        "de",
                                        "delivery_address.contactPerson"
                                      )
                                    ) +
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressAdditionalName",
                                        "de",
                                        "delivery_address.name4"
                                      )
                                    ) +
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressTelephone",
                                        "de",
                                        "delivery_address.phoneNumber"
                                      )
                                    ) +
                    ...
                    _c("div", { staticClass: "col-12" }, [
                      ...
                      _c("label", { attrs: { for: "showPickup" + _vm._uid } }, [
                        _vm._v(
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.addressToPickupStation"
                            )
                          )
                        )
                      ])
                    ...
                    [
                            ...
                            ? _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.addressPackingStation"
                                      )
                                    )
                                  )
                                ]
                            ...
                            ? _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.addressPostOffice"
                                      )
                                    )
                                  )
                                ]
                      ...
                      _c("label", { attrs: { for: "'address1' + _uid" } }, [
                        _vm._v(
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.addressPickupLocation"
                            )
                          )
                        )
                      ])
                        ...
                        ? _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.$translate(
                                    "Frontend::Template.addressPackingStationNumber"
                                  )
                                ) + "*"
                              )
                            ]
                        ...
                        ? _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.$translate(
                                    "Frontend::Template.addressPostOfficeNumber"
                                  )
                                ) + "*"
                              )
                            ]
                    ...
                    [
                      ...
                      _c("label", { attrs: { for: "postnumber" + _vm._uid } }, [
                        _vm._v(
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.addressPostNummer"
                            )
                          ) + "*"
                        )
                      ])
                            ...
                            [
                              _vm._v(
                                "\n                            " +
                                  _vm._s(
                                    _vm.transformTranslation(
                                      "Frontend::Template.addressAdditionalAddress2",
                                      "de",
                                      "delivery_address.address4"
                                    )
                                  ) +
              ...
              _c(
                ...
                [
                  ...
                  _c("label", { attrs: { for: "txtZip" + _vm._uid } }, [
                    _vm._v(
                      _vm._s(_vm.$translate("Frontend::Template.addressZip")) +
                        "*"
                    )
                  ])
                ]
              ...
              _c(
                ...
                [
                  ...
                  _c("label", { attrs: { for: "txtPlace" + _vm._uid } }, [
                    _vm._v(
                      _vm._s(
                        _vm.$translate("Frontend::Template.addressPlace")
                      ) + "*"
                    )
                  ])
                ]
                              ...
                              _c("input", {
                                attrs: {
                                  ...
                                  placeholder: _vm.$translate(
                                    "Frontend::Template.addressBirthdatePlaceholder"
                                  ),
                                ...
                                [
                                  _vm._v(
                                    "\n                            " +
                                      _vm._s(
                                        _vm.transformTranslation(
                                          "Frontend::Template.addressBirthdate",
                                          "de",
                                          "billing_address.birthday"
                                        )
                                      ) +
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.addressStreet"
                                )
                              ) + "*"
                            )
                          ]
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.addressNumber"
                                )
                              ) + "*"
                            )
                          ]
                            ...
                            [
                              _vm._v(
                                "\n                            " +
                                  _vm._s(
                                    _vm.transformTranslation(
                                      "Frontend::Template.addressAdditionalAddress1",
                                      "de",
                                      "billing_address.address3"
                                    )
                                  ) +
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressGBNameAffix",
                                        "gb",
                                        "billing_address.name4"
                                      )
                                    ) +
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.addressENAddressLine1"
                                )
                              ) + "*"
                            )
                          ]
                              ...
                              [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.transformTranslation(
                                        "Frontend::Template.addressENAddressLine2",
                                        "gb",
                                        "billing_address.address2"
                                      )
                                    ) +
                            ...
                            [
                              _vm._v(
                                "\n                            " +
                                  _vm._s(
                                    _vm.transformTranslation(
                                      "Frontend::Template.addressENAddressLine3",
                                      "gb",
                                      "billing_address.address3"
                                    )
                                  ) +
                            ...
                            [
                              _vm._v(
                                "\n                            " +
                                  _vm._s(
                                    _vm.transformTranslation(
                                      "Frontend::Template.addressENAddressLine4",
                                      "gb",
                                      "billing_address.address4"
                                    )
                                  ) +
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("label", { attrs: { for: "txtStreet" + _vm._uid } }, [
                        _vm._v(
                          _vm._s(
                            _vm.$translate("Frontend::Template.addressStreet")
                          ) + "*"
                        )
                      ])
                    ]
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("label", { attrs: { for: "txtNumber" + _vm._uid } }, [
                        _vm._v(
                          _vm._s(
                            _vm.$translate("Frontend::Template.addressNumber")
                          ) + "*"
                        )
                      ])
                    ]
      ...
      _c(
        ...
        [
          ...
          _c("label", { attrs: { for: "country-id-select" + _vm._uid } }, [
            _vm._v(_vm._s(_vm.$translate("Frontend::Template.headerCountry")))
          ])
        ]
      ),
      _vm._v(" "),
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.addressPleaseSelect"
                                )
                              )
                            )
                          ]
        ...
        _c("div", { staticClass: "col-sm-12" }, [
          _c(
            ...
            [
              ...
              _c("label", { attrs: { for: "email" + _vm._uid } }, [
                _vm._v(
                  _vm._s(_vm.$translate("Frontend::Template.regEmail")) + "*"
                )
              ])
            ]
          )
              ...
              _c(
                ...
                [
                              ...
                              _c("div", [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.regPasswordHintTitle"
                                      )
                                    ) +
                                    "\n                        "
                                )
                              ...
                              _c("ul", { staticClass: "pl-3" }, [
                                _c("li", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.regPasswordHintLength"
                                      )
                                    )
                                  )
                                ]),
                                ...
                                _c("li", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.regPasswordHintDigit"
                                      )
                                    )
                                  )
                                ]),
                                ...
                                _c("li", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.regPasswordHintChar"
                                      )
                                    )
                                  )
                                ])
                  ...
                  _c("label", { attrs: { for: "new-password-" + _vm._uid } }, [
                    _vm._v(
                      _vm._s(_vm.$translate("Frontend::Template.regPassword")) +
                        "*"
                    )
                  ])
                ],
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        _vm._s(
                          _vm.$translate("Frontend::Template.regRepeatPassword")
                        ) + "*"
                      )
                    ]
                  )
        ...
        [
          ...
          _c(
            ...
            [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.$translate("Frontend::Template.regRegister")) +
                  "\n            "
              ),
              _c("icon", {
              ...
              _c("label", { attrs: { for: "txtVatNumber" + _vm._uid } }, [
                _vm._v(
                  "\n            " +
                    _vm._s(
                      _vm.transformTranslation(
                        "Frontend::Template.addressVatNumber",
                        "de",
                        "billing_address.vatNumber"
                      )
                    ) +
...
//# sourceMappingURL=logic-client-2.js.map