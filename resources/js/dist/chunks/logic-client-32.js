...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    ...
    tooltipText: function tooltipText() {
      var tooltipText = this.$translate("Frontend::Template." + (this.isVariationInWishList ? "singleItemWishListRemove" : "singleItemWishListAdd"));
      return tooltipText;
    }
    ...
    addToWishList: function addToWishList() {
      ...
      if (!this.isLoading) {
        ...
        this.$store.dispatch("addToWishList", parseInt(this.currentVariationId)).then(function (response) {
          ...
          NotificationService.success(_this.$translate("Frontend::Template.singleItemWishListAdded")).closeAfter(3000);
        }, function (error) {
          _this.isLoading = false;
        });
      }
    ...
    removeFromWishList: function removeFromWishList() {
      ...
      if (!this.isLoading) {
        ...
        this.$store.dispatch("removeWishListItem", {
          ...
          NotificationService.success(_this2.$translate("Frontend::Template.singleItemWishListRemoved")).closeAfter(3000);
        }, function (error) {
          _this2.isLoading = false;
        });
      }
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(
        "\n    " +
          _vm._s(_vm.$translate("Frontend::Template.singleItemWishList")) +
          "\n"
      )
    ],
    1
...
//# sourceMappingURL=logic-client-32.js.map