    ...
    addToBasket: function addToBasket() {
      ...
      if (this.variationMissingProperties !== undefined && this.variationMissingProperties.length) {
        ...
        this.$store.dispatch("addBasketItem", basketObject).then(function (response) {
          ...
          if (error.data) {
            NotificationService.error(_this.$translate("Frontend::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_21__["default"].get(error.data.exceptionCode.toString()), error.data.placeholder)).closeAfter(5000);
          }
        });
      }
    },
      ...
      ? _c(
          "div",
          {
            ...
            attrs: {
              "data-toggle": "tooltip",
              "data-placement": "top",
              title: _vm.$translate("Frontend::Template.singleItemAddToBasket")
            },
            on: {
      ...
      ? _c(
          "div",
          {
            ...
            attrs: {
              "data-toggle": "tooltip",
              "data-placement": "top",
              title: _vm.$translate("Frontend::Template.itemShowItem")
            },
            on: {
              click: function($event) {
                    ...
                    [
                      ...
                      _vm._v(
                        "\n                " +
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.singleItemAddToBasket"
                            )
                          ) +
                          "\n            "
                      )
                  ...
                  : _c(
                      ...
                      [
                        ...
                        _vm._v(
                          "\n                " +
                            _vm._s(
                              _vm.$translate("Frontend::Template.itemShowItem")
                            ) +
                            "\n            "
                        )
                      ]
...
//# sourceMappingURL=logic-client-1.js.map