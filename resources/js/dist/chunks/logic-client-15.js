...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    privacyPolicyText: function privacyPolicyText() {
      var link = "<a href=\"" + App.urls.privacyPolicy + "\" target=\"_blank\"><span class=\"text-primary text-appearance\">" + this.$translate("Frontend::Template.checkoutPrivacyPolicy", {
        "hyphen": "&shy;"
      }) + "</span></a>";
      return this.$translate("Frontend::Template.newsletterAcceptPrivacyPolicy", {
        "policy": link
      });
    }
  },
  methods: {
    validateData: function validateData() {
      ...
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_7__["default"].validate($("#newsletter-input-form_" + this._uid)).done(function () {
        ...
        invalidFields.filter(function (field) {
          ...
          if (field.type === '!regex') {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(_this.$translate("Frontend::Template.newsletterNotAllowedCharacters", {
              name: field.name
            }));
          }
        });
    ...
    save: function save() {
      ...
      if (App.config.global.googleRecaptchaApiKey && (!window.grecaptcha || !recaptchaEl)) {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(this.$translate("Frontend::Template.newsletterAcceptRecaptchaCookie"));
      ...
      Object(_helper_executeReCaptcha__WEBPACK_IMPORTED_MODULE_8__["executeReCaptcha"])(this.$el).then(function (recaptchaToken) {
        _services_ApiService__WEBPACK_IMPORTED_MODULE_5__["default"].post("/rest/io/customer/newsletter", {
          ...
          if (!!data.containsHoneypot) {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].warn(_this2.$translate("Frontend::Template.newsletterHoneypotWarning"));
          } else {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].success(_this2.$translate("Frontend::Template.newsletterSuccessMessage")).closeAfter(3000);
          }

          _this2.resetInputs();
        }).fail(function () {
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(_this2.$translate("Frontend::Template.newsletterErrorMessage")).closeAfter(5000);
        }).always(function () {
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        _vm._s(
                          _vm.$translate(
                            "Frontend::Template.newsletterFirstName"
                          )
                        )
                      )
                    ]
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        _vm._s(
                          _vm.$translate(
                            "Frontend::Template.newsletterLastName"
                          )
                        )
                      )
                    ]
            ...
            _c(
              ...
              [
                _c("label", { attrs: { for: "email-input-id_" + _vm._uid } }, [
                  _vm._v(
                    _vm._s(
                      _vm.$translate("Frontend::Template.newsletterEmail")
                    ) + " *"
                  )
                ]),
                _vm._v(" "),
              ...
              [
                ...
                _vm._v(
                  "\n                    " +
                    _vm._s(
                      _vm.$translate(
                        "Frontend::Template.newsletterSubscribeButtonLabel"
                      )
                    ) +
                    "\n                "
                )
...
//# sourceMappingURL=logic-client-15.js.map