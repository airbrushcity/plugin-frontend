  ...
  methods: {
    ...
    sendResetPwd: function sendResetPwd() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"].post("/rest/io/customer/password_reset", {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_3__["default"].success(_this3.$translate("Frontend::Template.loginSendEmailOk")).closeAfter(5000);
      }).fail(function () {
        _this3.isDisabled = false;
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_3__["default"].error(_this3.$translate("Frontend::Template.loginResetPwDErrorOnSendEmail")).closeAfter(5000);
      });
    },
            ...
            _c("div", { staticClass: "modal-content" }, [
              _c("div", { staticClass: "modal-header" }, [
                _c("div", { staticClass: "modal-title h3" }, [
                  _vm._v(
                    _vm._s(
                      _vm.$translate("Frontend::Template.loginForgotPassword")
                    )
                  )
                ]),
                _vm._v(" "),
                  ...
                  [
                    _c("span", { staticClass: "info-badge" }, [
                      _vm._v(
                        _vm._s(
                          _vm.$translate(
                            "Frontend::Template.loginForgotPasswordInfo"
                          )
                        )
                      )
                    ])
                  ...
                  _c("div", { staticClass: "col-12" }, [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("label", { attrs: { for: "mail" + _vm._uid } }, [
                          _vm._v(
                            _vm._s(
                              _vm.$translate("Frontend::Template.loginEmail")
                            ) + "*"
                          )
                        ])
                      ]
                    ...
                    _c("span", { staticClass: "error-msg" }, [
                      _vm._v(
                        _vm._s(
                          _vm.$translate(
                            "Frontend::Template.loginEnterConfirmEmail"
                          )
                        )
                      )
                    ])
                          ...
                          [
                            ...
                            _vm._v(
                              "\n                                " +
                                _vm._s(
                                  _vm.$translate(
                                    "Frontend::Template.loginBackToLogin"
                                  )
                                ) +
                                "\n                            "
                            )
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n\t\t\t\t\t\t\t\t" +
                            _vm._s(
                              _vm.$translate("Frontend::Template.loginSend")
                            ) +
                            "\n\t\t\t\t\t\t\t\t"
                        ),
                        _c("icon", {
...
//# sourceMappingURL=logic-client-27.js.map