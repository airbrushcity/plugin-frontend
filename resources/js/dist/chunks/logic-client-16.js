  ...
  methods: {
    ...
    save: function save() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"].del("/rest/io/customer/newsletter/" + this.email, {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_4__["default"].success(_this2.$translate("Frontend::Template.newsletterOptOutSuccessMessage")).closeAfter(3000);

        _this2.resetInputs();
      }).fail(function () {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_4__["default"].error(_this2.$translate("Frontend::Template.newsletterOptOutErrorMessage")).closeAfter(5000);
      }).always(function () {
          ...
          _c(
            ...
            [
              _c("label", { attrs: { for: "email-input-id" } }, [
                _vm._v(
                  _vm._s(_vm.$translate("Frontend::Template.newsletterEmail"))
                )
              ]),
              _vm._v(" "),
              _c("input", {
              ...
              [
                ...
                _c("span", [
                  _vm._v(
                    _vm._s(
                      _vm.$translate(
                        "Frontend::Template.newsletterUnsubscribeButtonLabel"
                      )
                    )
                  )
                ])
...
//# sourceMappingURL=logic-client-16.js.map