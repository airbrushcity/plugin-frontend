  ...
  computed: {
    ...
    text: function text() {
      var links = {
        ...
        cancellation: "<a class=\"text-appearance\" href=\"" + App.urls.cancellationRights + "\" target=\"_blank\">" + this.$translate("Frontend::Template.checkoutCancellationRight", {
          "hyphen": "&shy;"
        }) + "</a>",
        policy: "<a class=\"text-appearance\" href=\"" + App.urls.privacyPolicy + "\" target=\"_blank\">" + this.$translate("Frontend::Template.checkoutPrivacyPolicy", {
          "hyphen": "&shy;"
        }) + "</a>",
                                        ...
                                        : [
                                            _vm._v(
                                              "\n                                    " +
                                                _vm._s(
                                                  _vm.$translate(
                                                    "Frontend::Template.privacySettingsDefaultGroup"
                                                  )
                                                ) +
                                                "\n                                "
                                            )
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(
                              _vm.$translate(
                                "Frontend::Template.cookieBarMoreSettings"
                              )
                            )
                          )
                        ]
                      ...
                      [
                        _vm._v(
                          "\n                    " +
                            _vm._s(
                              _vm.$translate(
                                "Frontend::Template.cookieBarAcceptAll"
                              )
                            ) +
                            "\n                "
                        )
                          ...
                          [
                            _vm._v(
                              "\n                    " +
                                _vm._s(
                                  _vm.$translate(
                                    "Frontend::Template.cookieBarDenyAll"
                                  )
                                ) +
                                "\n                "
                            )
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                    " +
                            _vm._s(
                              _vm.$translate("Frontend::Template.cookieBarSave")
                            ) +
                            "\n                "
                        )
                      ]
                        ...
                        [
                          _vm._v(
                            "\n                    " +
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.cookieBarBack"
                                )
                              ) +
                              "\n                "
                          )
                            ...
                            [
                              _vm._v(
                                "\n                            " +
                                  _vm._s(
                                    _vm.$translate(
                                      "Frontend::Template.cookieBarSave"
                                    )
                                  ) +
                                  "\n                        "
                              )
              ...
              "button",
              {
                ...
                attrs: {
                  "aria-label": _vm.$translate(
                    "Frontend::Template.cookieBarPrivacySettings"
                  )
                },
                on: {
                  click: function($event) {
...
//# sourceMappingURL=logic-17.js.map