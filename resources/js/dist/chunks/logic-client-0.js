...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    ...
    minimumHint: function minimumHint() {
      return this.$translate("Frontend::Template.singleItemQuantityMin", {
        min: this.$options.filters.numberFormat(this.compMin)
      });
    },
    maximumHint: function maximumHint() {
      return this.$translate("Frontend::Template.singleItemQuantityMax", {
  ...
  return _c("div", { staticClass: "qty-box d-flex h-100" }, [
    _c("input", {
      ...
      attrs: {
        ...
        "aria-label": _vm.$translate("Frontend::Template.itemQuantityInput")
      },
        ...
        "button",
        {
          ...
          attrs: {
            ...
            "aria-label": _vm.$translate(
              "Frontend::Template.itemQuantityInputIncrease"
            )
          },
          on: {
      ...
      _c(
        "button",
        {
          ...
          attrs: {
            ...
            "aria-label": _vm.$translate(
              "Frontend::Template.itemQuantityInputDecrease"
            )
          },
          on: {
            click: function($event) {
...
//# sourceMappingURL=logic-client-0.js.map