  ...
  methods: {
    ...
    sendLogin: function sendLogin() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"].post("/rest/io/customer/login", {
        ...
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_3__["default"].success(_this3.$translate("Frontend::Template.loginSuccessful")).closeAfter(3000);
        ...
        switch (response.error.code) {
          case 401:
            ...
            var translationKey = "Frontend::Template.loginFailed";

            if (response.error.message.length > 0 && response.error.message === "user is blocked") {
              translationKey = "Frontend::Template.loginBlocked";
            }
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-12" }, [
              _c(
                ...
                [
                  ...
                  _c("label", { attrs: { for: "email" + _vm._uid } }, [
                    _vm._v(
                      _vm._s(_vm.$translate("Frontend::Template.loginEmail")) +
                        "*"
                    )
                  ])
                ]
              ...
              _c("span", { staticClass: "error-msg" }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate("Frontend::Template.loginEnterConfirmEmail")
                  )
                )
              ])
            ]),
            ...
            _c("div", { staticClass: "col-12" }, [
              _c(
                ...
                [
                  ...
                  _c("label", { attrs: { for: "password" + _vm._uid } }, [
                    _vm._v(
                      _vm._s(
                        _vm.$translate("Frontend::Template.loginPassword")
                      ) + "*"
                    )
                  ])
                ]
              ...
              _c("span", { staticClass: "error-msg" }, [
                _vm._v(
                  _vm._s(
                    _vm.$translate("Frontend::Template.loginEmptyPassword")
                  )
                )
              ])
            ])
              ...
              [
                ...
                _c(
                  ...
                  [
                    _vm._v(
                      "\n                    " +
                        _vm._s(_vm.$translate("Frontend::Template.login")) +
                        "\n                    "
                    ),
                    _c("icon", {
...
//# sourceMappingURL=logic-client-14.js.map