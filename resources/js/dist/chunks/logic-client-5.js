      ...
      if (event.detail.itemId === _this.itemId) {
        ...
        if (_this.property.valueType === "selection") {
          ...
          if (_this.property.value && _this.property.value.length) {
            NotificationService.warn(_services_TranslationService__WEBPACK_IMPORTED_MODULE_21__["default"].translate("Frontend::Template.singleItemOrderPropertyFileHasReset", {
  ...
  methods: _objectSpread({
    ...
    _handleValidationErrors: function _handleValidationErrors(error) {
      ...
      if (error.error.message && error.error.message === "Post too large") {
        NotificationService.error(this.$translate("Frontend::Template.errorPostTooLarge", {
                    ...
                    return _c("span", {
                      ...
                      attrs: {
                        ...
                        title: propertyGroup.group
                          ...
                          : _vm.$translate(
                              "Frontend::Template.singleItemPropertiesWithoutGroup"
                            )
                      },
                      on: {
                        click: function($event) {
...
//# sourceMappingURL=logic-client-5.js.map