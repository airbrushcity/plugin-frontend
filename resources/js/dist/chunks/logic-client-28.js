          ...
          _c(
            ...
            [
              _c("h1", { staticClass: "login-view-title mb-5" }, [
                _vm._v(_vm._s(_vm.$translate("Frontend::Template.login")))
              ]),
              _vm._v(" "),
              _c("login", {
                attrs: {
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._v(
                      "\n                        " +
                        _vm._s(
                          _vm.$translate("Frontend::Template.loginRegister")
                        ) +
                        "\n                    "
                    )
                  ]
                    ...
                    [
                      ...
                      _vm._v(
                        "\n                        " +
                          _vm._s(
                            _vm.$translate(
                              "Frontend::Template.loginOrderAsGuest"
                            )
                          ) +
                          "\n                    "
                      )
          ...
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-header" }, [
              _c("div", { staticClass: "modal-title h3" }, [
                _vm._v(
                  _vm._s(_vm.$translate("Frontend::Template.loginOrderAsGuest"))
                )
              ]),
              _vm._v(" "),
              _c(
                "button",
                {
                  ...
                  attrs: {
                    ...
                    "data-dismiss": "modal",
                    "aria-hidden": "true",
                    "aria-label": _vm.$translate("Frontend::Template.closeIcon")
                  }
                },
                [_vm._v("×")]
              )
...
//# sourceMappingURL=logic-client-28.js.map