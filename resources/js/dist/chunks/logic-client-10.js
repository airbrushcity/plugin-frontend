  ...
  methods: _objectSpread({
    ...
    removeItem: function removeItem() {
      ...
      this.removeWishListItem(item).then(function () {
        return _services_NotificationService__WEBPACK_IMPORTED_MODULE_9__["default"].success(_this.$translate("Frontend::Template.wishListRemoved")).closeAfter(3000);
      });
    }
    ...
    [
      ...
      !_vm.isLoading && (!_vm.wishListItems || _vm.wishListItems.length === 0)
        ? _c("p", { staticClass: "h4 text-muted text-center my-5" }, [
            _vm._v(_vm._s(_vm.$translate("Frontend::Template.wishListNoItems")))
          ])
        : _vm._e(),
      _vm._v(" "),
                        ...
                        _c("div", [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.wishListContent"
                                )
                              ) + ": "
                            )
                          ]),
                ...
                _c(
                  ...
                  [
                    _vm._v(
                      "\n                            " +
                        _vm._s(
                          _vm.$translate("Frontend::Template.wishListDelete")
                        ) +
                        "\n                            "
                    ),
                    _c("i", {
                ...
                ? [
                    _c("div", { staticClass: "mt-3" }, [
                      _c("strong", [
                        _vm._v(
                          _vm._s(
                            _vm.$translate("Frontend::Template.wishListItemId")
                          ) + ":"
                        )
                      ]),
                      _vm._v(" "),
                      ...
                      ? _c("div", [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.wishListItemNumber"
                                )
                              ) + ":"
                            )
                          ]),
                      ...
                      ? _c("div", [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.$translate(
                                  "Frontend::Template.wishListAvailability"
                                )
                              ) + ":"
                            )
                          ]),
...
//# sourceMappingURL=logic-client-10.js.map