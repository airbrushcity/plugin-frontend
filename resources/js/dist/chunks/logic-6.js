    ...
    ? _c(
        "a",
        {
          ...
          attrs: {
            ...
            href: _vm.itemUrl,
            role: "listbox",
            "aria-label": _vm.$translate("Frontend::Template.itemImageCarousel")
          }
        },
                    ...
                    _vm._l(_vm.item.groupedAttributes, function(attribute) {
                      return _c("span", [
                        _vm._v(
                          _vm._s(
                            _vm._f("translate")(
                              "Frontend::Template.itemGroupedAttribute",
                              attribute
                            )
                          )
                        )
                            ...
                            ? [
                                _vm._v(
                                  "\n                                " +
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.itemSetPrice",
                                    ...
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.categoryItemFootnote"
                                      )
                                    ) +
                                    "\n                            "
                                )
                            ...
                            ? [
                                _vm._v(
                                  "\n                                " +
                                    _vm._s(
                                      _vm.$translate(
                                        "Frontend::Template.categoryItemFromPrice",
...
//# sourceMappingURL=logic-6.js.map